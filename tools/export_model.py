...
'''
"args": ["--config", "configs/rec/rec_r31_robustscanner.yml", 
                "-o", "Global.checkpoints=./output/rec/rec_r31_robustscanner/best_accuracy",
                "Global.save_inference_dir=./inference/norm" 
            ]
'''